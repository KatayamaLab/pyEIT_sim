...
fig1.suptitle(
    "Experiment A (GREIT): Row-wise Unified Scale (Per-Day Comparison)", fontsize=16, y=0.995
)
...
plt.tight_layout()
plt.savefig("experiment_A_greit_unified_scale.png", dpi=150, bbox_inches="tight")
print("  -> experiment_A_greit_unified_scale.png saved (row-wise scale)")
...
fig2.suptitle(
    "Experiment A (GREIT): Individual Color Scale (Detail View)", fontsize=16, y=0.995
)
...
plt.tight_layout()
plt.savefig("experiment_A_greit_individual_scale.png", dpi=150, bbox_inches="tight")
print("  -> experiment_A_greit_individual_scale.png saved")
...
plt.tight_layout()
plt.savefig("experiment_B_greit_position_error.png", dpi=150, bbox_inches="tight")
print("\nExperiment B completed: experiment_B_greit_position_error.png saved")
...
for noise_level in noise_levels_B:
    ...
    if valid_errors:
        ...
        threshold_contrasts = [
            c for c, pe in zip(contrasts_list, position_errors) 
